              ...
              <div class="container-xxl">
                <div
                  ...
                  <div class="text-body">
                    ...
                    , made with ❤️ by <a href="https://hydra-dev.xyz" target="_blank" class="footer-link">Hydra Dev</a>
                  </div>
                  <div class="d-none d-lg-inline-block">
                    <a>Version 1.0.0 Alpha</a>
                  </div>
                </div>
              </div>
            </footer>
...
$(document).ready(function() {
  ...
  // Mostra il loader quando la pagina si carica
  ...
  // Aggiunge stile custom per SweetAlert
